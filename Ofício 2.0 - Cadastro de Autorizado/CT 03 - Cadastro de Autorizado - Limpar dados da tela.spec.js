...
describe('Oficio 2.0', function () {
  ...
  describe('Cadastro Autorizado - Limpar dados da tela', function () {
    it('Cadastro Autorizado - Limpar dados da tela', function () {
      ...
      cy.get('#formAutorizado').contains('Limpar') // Clicar no botão de limpar
    })
  })
})